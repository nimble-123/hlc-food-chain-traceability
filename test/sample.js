...
const namespace = 'io.dev.foodchain';
...
describe('Sample', () => {
    ...
    it('Alice can submit a transaction for her assets', async () => {
        ...
        event.asset.getFullyQualifiedIdentifier().should.equal('io.dev.foodchain.SampleAsset#1');
    ...
    it('Bob can submit a transaction for his assets', async () => {
        ...
        event.eventId.should.be.a('string');
        event.timestamp.should.be.an.instanceOf(Date);
        event.asset.getFullyQualifiedIdentifier().should.equal('io.dev.foodchain.SampleAsset#2');
